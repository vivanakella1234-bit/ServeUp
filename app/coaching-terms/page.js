...
export const metadata = {
  title: 'Coaching Terms — ServeUp',
  description: 'ServeUp coaching terms: platform fee, payouts, and how the platform works for coaches.',
}
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-20 px-6">
      <div className="max-w-2xl mx-auto">
        <Link href="/for-coaches" className="text-green-700 text-sm font-medium hover:underline mb-8 inline-block">← Back to coaches page</Link>
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-2xl border border-gray-100 p-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ServeUp charges a <strong>10% platform fee</strong> on each completed session. This is deducted automatically from the session payment — you receive 90% of your listed rate directly to your connected bank account.
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={rate + duration} className="flex items-center justify-between text-sm border-b border-gray-100 pb-3 last:border-0 last:pb-0">
                  ...
                  <p className="text-green-800 font-black text-base">{payout} <span className="text-xs text-gray-400 font-normal">to you</span></p>
                </div>
              ))}
            </div>
          ...
          <section className="bg-white rounded-2xl border border-gray-100 p-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Creating and maintaining your ServeUp profile is always free. The platform fee only applies when a session is completed and paid. There are no monthly subscription fees, no listing fees, and no hidden charges.
            </p>
          </section>
        ...
        <div className="text-center mt-12">
          <Link href="/auth/signup?role=coach"
            className="inline-block bg-green-800 text-white font-bold px-8 py-4 rounded-xl hover:bg-green-900 transition">

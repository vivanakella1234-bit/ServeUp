...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-600 flex flex-col items-center justify-center text-center px-6 pt-16">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-white leading-tight max-w-4xl mb-6" style={{letterSpacing:'-2px'}}>
          Your next coach is already in <span className="text-blue-400">your city.</span>
        </h1>
        <p className="text-white/75 text-lg md:text-xl max-w-xl mb-10">
          TennisCoach connects serious tennis players with verified private coaches — wherever you are. No more losing weeks of training time to a city change.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 flex-wrap justify-center">
          <Link href="/match" className="bg-white text-blue-800 font-bold px-8 py-4 rounded-xl hover:shadow-xl transition-all hover:-translate-y-0.5">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={title} className="card p-8">
                <div className="w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center text-2xl mb-4">{icon}</div>
      ...
      <section className="py-24 px-6 bg-blue-900">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-blue-400 font-semibold text-sm uppercase tracking-wider mb-3">Trust & credentials</p>
